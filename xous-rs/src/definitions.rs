...
pub const FLASH_PHYS_BASE: u32 = 0x6000_0000;
...
pub const LOADER_CODE_LEN: u32 = 0x0000_4000; // code region only
pub const LOADER_FONT_LOC: u32 = 0x0000_4000; // should be the same as graphics-server/src/fontmap.rs/FONT_BASE
pub const LOADER_FONT_LEN: u32 = 0x0000_0000; // length of font region only
pub const LOADER_TOTAL_LEN: u32 = LOADER_CODE_LEN + LOADER_FONT_LEN; // code + font

pub const EARLY_SETTINGS: u32 = 0x0050_4000;

pub const KERNEL_LOC: u32 = 0x0050_5000; // kernel start
pub const KERNEL_LEN: u32 = 0x0010_0000; // max kernel length = 0xA0_0000 * 2 => half the area for backup kernel & updates
